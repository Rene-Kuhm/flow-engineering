...
class TestEngramClientSaveLoad:
    def test_save_and_load_phase(self) -> None:
        ...
        assert loaded == "## Exploration content here"
    ...
    def test_two_changes_isolated(self) -> None:
        ...
        assert client_a.load_phase("explore") == "A explore content"
        assert client_b.load_phase("explore") == "B explore content"
...
class TestApplyProgress:
    def test_save_progress_creates_task(self) -> None:
        ...
        loaded = json.loads(client.load_phase("apply-progress"))
