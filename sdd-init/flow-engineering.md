...
conventions:
  ...
  spec_as_truth: openspec/changes/{name}/{spec,design,tasks,verify}.md is contract
---
...
`flow_engineering.strict_tdd.load_sdd_init(repo_root)` reads this file
and matches one of the 4 `on_markers` patterns in `strict_tdd.py:34-44`,
